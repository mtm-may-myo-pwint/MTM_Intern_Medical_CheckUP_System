                    ...
                    <div class="col-md-4">
                        <form action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div>
                                        <button type="submit" class="btn btn-outline-primary me-2"><i class="fas fa-magnifying-glass"></i></button>
                                    </div>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="col-md-8 create text-end">
                        <!-- <a href="{{ asset('file/excel_sample.xlsx') }}" class="btn btn-outline-secondary">
                            {{__('Download Sample')}}
                        </a> -->
                        @can('is_admin')
