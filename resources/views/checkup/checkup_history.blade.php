        ...
        <div class="card-body">
            <div class="row mb-3 mt-3">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="month" class="form-control" name="from_date" id="from_date" value="{{ request('from_date',now()->subYear()->startOfYear()->format('Y-m')) }}" onkeydown="return false;">
                </div>
                <div class="form-group col-md-2">
                    <div class="form-label">{{__('YYYYMM (TO)')}}</div>
                    <input type="month" class="form-control" name="to_date" id="to_date" value="{{ request('to_date',now()->format('Y-m')) }}" onkeydown="return false;">
                </div>
                <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-2 d-flex align-items-end">
                    <div>
                        <button class="btn btn-outline-primary me-1 search"><i class="fas fa-magnifying-glass"></i> {{__('Search')}}</button>
            ...
            <div class="mt-3">
                <a href="{{route('checkup.current_month')}}" class="btn btn-outline-primary ml-auto"> {{ __('Check-up Current Month List') }}</a>
            </div>
            <div class="row mt-3">
                <div class="col-md-12">
                    <table class="table table-bordered">
                        <thead class="table-secondary">
                            <tr>
                                ...
                                <th class="text-center text-nowrap">{{ __('Hepatitis B 4th Dose @ MTM ') }}</th>
                    ...
                    <!-- Orignal Pagination -->
                    <div class="mt-3" id="original-pagination">
                        {{ $checkup_history->links('pagination::bootstrap-5') }}
                    </div>
